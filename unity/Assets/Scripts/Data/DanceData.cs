...
namespace PoseTeacher {
    ...
    public interface IDanceGoal: IComparable<IDanceGoal> {
        GoalType GetGoalType();
        int startingID();
    }

    [System.Serializable]
    public class DanceGoalPose : IDanceGoal {
        public int id;

        public int CompareTo(IDanceGoal other) {
            return id.CompareTo(other.startingID());
        }
    ...
    [System.Serializable]
    public class DanceGoalMotion: IDanceGoal {
        public int startId;
        public int endId;

        public int CompareTo(IDanceGoal other) {
            return startId.CompareTo(other.startingID());
        }

        public GoalType GetGoalType() {
            return GoalType.MOTION;
        }
